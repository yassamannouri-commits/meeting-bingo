...
graph TB
    subgraph Browser["Browser Environment"]
        subgraph ReactApp["React Application"]
            ...
            SR["Speech Recognition<br/>Web Speech API · Word Detection"]
            CTX["Context State"]
...
graph TD
    ...
    A --> A1["Real-time sync across players<br/>Shared game state · Live leaderboard<br/>Cost: $5–20/month"]
    B --> B1["No backend required<br/>Direct browser connections<br/>Limited to ~10 players · Free"]
    C --> C1["Managed real-time sync<br/>Generous free tier<br/>Easy implementation · Free up to 100 concurrent"]
```
